<?php
    ...
    $vigor = $cacciatrice_stats['vigore'];
    $intelligence = $cacciatrice_stats['intelligenza'];
    $strength = $cacciatrice_stats['forza'];
    $resistance = $cacciatrice_stats['resistenza'];
    $maxexp = $cacciatrice_stats['esperienza_massima'];
?>
...
<body>
    <div class="game-container">
        <div class="container">
            ...
            <img src="/immagini/cacciatrice.png" alt="Huntress" class="image">
    ...
    <script>
        ...
        var expPercentage = (cacciatriceExp / <?php echo $maxexp; ?>) * 100;

        document.querySelector('.level-container').innerHTML = '';
        for (var i = 1; i <= 5; i++) {
            var levelClass = (i <= cacciatriceLivello) ? '' : 'locked';
        ...
        document.querySelector('.experience-text').innerText = (cacciatriceLivello === 5) ? "MAX" : (cacciatriceExp + '/' + <?php echo $maxexp; ?>);
        ...
        var vigore_base = vigor_base + (cacciatriceLivello - 1) * 1;
        var intelligenza_base = intelligence_base + (cacciatriceLivello - 1) * 1;
        var forza_base = strength_base + (cacciatriceLivello - 1) * 2;
        var resistenza_base = resistance_base + (cacciatriceLivello - 1) * 1;
